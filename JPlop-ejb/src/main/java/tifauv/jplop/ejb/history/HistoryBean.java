...
public class HistoryBean implements HistoryLocal {
	 ...
	 * 
	 * @see tifauv.jplop.ejb.history.HistoryLocal#createPost(tifauv.jplop.entity.Post, java.util.Date, java.lang.String, java.lang.String, tifauv.jplop.entity.Account)
	 */
	@Override
	 ...
	 *
	 * @see tifauv.jplop.ejb.history.HistoryLocal#findPost(java.util.Date, int)
	 */
	@Override
	public Post findPost(Date p_time, int p_rank) {
		...
		return (Post)m_entities.createNamedQuery("findPostByClockAndRank")
		.setParameter("time", p_time)
		.setParameter("rank", p_rank)
		.getSingleResult();
	}
	 ...
	 * 
	 * @see tifauv.jplop.ejb.history.HistoryLocal#getLastPosts(int)
	 */
	@Override
